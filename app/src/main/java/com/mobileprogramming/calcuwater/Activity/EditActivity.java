...
public class EditActivity extends AppCompatActivity {
    ...
    String ID;
    String date;
    ImageButton btnSubmit, btnUpload, btnDelete, btnBack;
    TextView tvDebit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtName.setText(mIntent.getStringExtra("Nama"));
        edtLebar.setText(mIntent.getStringExtra("Lebar_ambang"));
        edtTinggi.setText(mIntent.getStringExtra("Tinggi_bukaan"));
        edtSelisih.setText(mIntent.getStringExtra("Selisih_tinggi"));
        hitungData();
    ...
    private void updateData() {
        Call<PostPutDelData> putDataCall = mApiInterface.postUpdateData("update_tabeldata",
                ID,
        ...
        putDataCall.enqueue(new Callback<PostPutDelData>() {
            ...
            public void onResponse(Call<PostPutDelData> call, Response<PostPutDelData> response) {
                Intent moveIntent = new Intent(EditActivity.this, HistoryActivity.class);
    ...
    private void hapusData() {
        Call<PostPutDelData> deleteHeros = mApiInterface.deleteData("delete_tabeldata", ID);
        deleteHeros.enqueue(new Callback<PostPutDelData>() {
            @Override
            public void onResponse(Call<PostPutDelData> call, Response<PostPutDelData> response) {
                Intent moveIntent = new Intent(EditActivity.this, HistoryActivity.class);
                startActivity(moveIntent);
